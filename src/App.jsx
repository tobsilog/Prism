...
const App = () => {
  ...
  return (
    <div className="w-full relative">
      <nav className="fixed top-0 left-0 w-full bg-white shadow-lg z-20 h-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-full">
          <img 
            ...
            style={{ width: '70px' }}
          />
          <h2 className="text-3xl font-bold text-blue-600">Thinking Forward, Leading Change</h2>
          <button
            onClick={toggleSidebar}
            className="p-2 text-blue-500 hover:text-blue-700 focus-visible:outline-none border-none bg-transparent"
          >
      ...
      >
        <div className="relative z-10 w-[90vw] h-[80vh] max-w-6xl bg-white bg-opacity-20 shadow-2xl overflow-y-auto p-8 flex flex-col md:flex-row justify-center items-center gap-8">
          ...
          <div className="w-full md:w-1/3 p-6">
            <div className="flex flex-col items-center">
              ...
              />
              <h3 className="text-2xl font-semibold text-blue-800 mb-4 text-center">Business Operations</h3>
              <ul className="space-y-3 w-full">
                {BusinessOps.map((item, index) => (
                  <li key={index} className="flex items-start">
                    <span 
                      className="w-5 h-5 mr-3 bg-contain bg-center bg-no-repeat flex-shrink-0 mt-1"
          ...
          <div className="w-full md:w-1/3 p-6">
            <div className="flex flex-col items-center">
              <img 
                ...
                className="w-full max-w-[250px] h-auto object-contain mb-4"
              />
              <h3 className="text-2xl font-semibold text-blue-800 mb-4 text-center">Business Management</h3>
              <ul className="space-y-3 w-full">
          ...
          <div className="w-full md:w-1/3 p-6">
            <div className="flex flex-col items-center">
              <img 
                ...
                className="w-full max-w-[250px] h-auto object-contain mb-4"
              />
              <h3 className="text-2xl font-semibold text-blue-800 mb-4 text-center">Tech Solutions</h3>
              <ul className="space-y-3 w-full">
      ...
      >
        <div className="relative z-10 w-[90vw] h-[80vh] max-w-6xl bg-white bg-opacity-80 shadow-lg overflow-y-auto p-8 md:p-12">
          <div className="h-full flex flex-col justify-center">
          
            <h1 className="text-4xl font-bold text-gray-800 mb-8 text-left">About</h1>
